                    ...
                    <div className="roadmap-mobile">
                        ...
                        <div className="wrapper-event">
                            ...
                            <p className="activities">
                                ...
                                More liquidity
                                <br />
                                Create/Manage pairs + liquidity
                                <br />
                                groups NFTs Event
                                <br />
                                Design NFTs, Create Events
                                <br />
                                Event advertising
                                <br />
                                Marketplace StarkFinance
                            </p>
                        </div>
                        <div className="wrapper-event">
